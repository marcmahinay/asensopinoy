            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div>
                            <h5 class="card-title mb-0">Assistance Release Chart</h5>
                        </div>
                        <div class="ms-auto">
        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-flex">
                        <div>
                            <h5 class="card-title">Assistance Release of the Month</h5>
                        </div>
                        <div class="ms-auto">
                            <select class="form-select b-0">
                    ...
                    <div class="table-responsive mt-3 no-wrap">
                        <table class="table vm no-th-brd pro-of-month">
                            ...
                            <tbody>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="{{ asset('storage/member/2.jpg') }}"
