        ...
        <!-- Column -->
         <div class="col-lg-12 col-xlg-12 col-md-12">
            <div class="card">
                <!-- Tab panes -->
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" method="POST" action="{{ route('ayuda.store')}}">
                        @csrf
                        @method('POST')
                        <div class="form-group">
                            <label class="col-sm-12">Create Ayuda</label>
                            <div class="col-sm-12">
                                <input type="text" value="" class="form-control form-control-line" name="ayuda_name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
