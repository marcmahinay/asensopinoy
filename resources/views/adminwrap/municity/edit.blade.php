        ...
        <!-- Column -->
         <div class="col-lg-12 col-xlg-12 col-md-12">
            <div class="card">
                <!-- Tab panes -->
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" method="POST" action="{{ route('municity.update',$municity)}}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label class="col-sm-12">Municipality/City Name</label>
                            <div class="col-sm-12">
                                <input type="text" value="{{$municity->name}}" class="form-control form-control-line" name="municity_name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
